...
but there are still divergent transitions (even after increasing iterations and adapt_delta)
...
priors <- c(set_prior("normal(1604, 50)", class = "Intercept"),
                      set_prior("normal(0, 1)", class = "b", 
                                coef = "F2V"),
                      set_prior("normal(0, 500)", class = "b",
                                coef = "C1d"),
...
```
```{r}
plot(bCVC_int_center, variable = c("Intercept", "b_F2V"))
```
